...
============================================================
  Claude Code
============================================================
今日: 340 次 | 输入 1,495,557 | 输出 236,097 | 缓存读 30,880,024 | 命中率 95.4% | 合计 32,611,678
本月: 5,357 次 | 输入 30,712,822 | 输出 3,990,898 | 缓存读 526,393,088 | 命中率 94.5% | 合计 561,096,808
全部: ...
...
============================================================
今日: 无记录
本月: 42 次 | 输入 2,826,165 | 缓存读 2,423,040 | 命中率 46.2% | 输出 42,775 | 合计 5,291,980
全部: ...
...
Codex 从 `event_msg.token_count` 的累计值计算 delta，字段为输入 / 缓存读 / 命中率 / 输出。
缓存命中率 = 缓存读 / (输入 + 缓存读)。
